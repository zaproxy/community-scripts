...
function scan(ps, msg, src) {
  ...
  var alertSolution = [
    "Ensure proper sanitisation is done on the server side, or don't. I don't care.",
    "",
  ];
  var cweId = [0, 1];
  var wascId = [0, 1];
